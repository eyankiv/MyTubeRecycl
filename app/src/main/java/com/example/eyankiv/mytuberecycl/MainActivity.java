...
public class MainActivity extends YouTubeBaseActivity implements YouTubePlayer.OnFullscreenListener{
    ...
    public static final String RAW_URL = "http://www.razor-tech.co.il/hiring/youtube-api.json"; //if the website works
...
//                    }
  //              });
                mRecycAdapter = new MyRecycAdapter(MainActivity.this, tubeVodItems, new MyRecycAdapter.TubeItemClickListener() {
                    @Override
